 ...
 */
print("Falcon doesn't have a weapon because it was defined on another playground page.")
let falcon = Spaceship()
falcon.name = "Falcon"
// print(falcon.weapon)
print("Even after we redefine it, we can't call 'weapon()' because it's defined in the subclass, not the base class.")
/*:
...
for _ in 0..<11 {
    destroyer.fire()
    print("The destroyer has: \(destroyer.remainingFirePower) firepower left")
}

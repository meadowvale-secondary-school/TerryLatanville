...
defender.moveRight()
print("Defender is now at position: \(defender.position)")
defender.fire()
print("Defender now has \(defender.remainingFirePower) remaining fire power")
/*:
 ...
 */
defender.wasHit()
print("Defender's Shield Strength: \(defender.shieldStrength)")
print("Defender's Health: \(defender.health)")
/*:

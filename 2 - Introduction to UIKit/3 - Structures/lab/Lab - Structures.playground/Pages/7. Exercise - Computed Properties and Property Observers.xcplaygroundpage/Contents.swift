...
struct Height {
    var heightInInches: Double {
        didSet {
            guard abs(heightInCentimeters - heightInInches * 2.54) > Double.ulpOfOne else { return }
    ...
    var heightInCentimeters: Double {
        didSet {
            guard abs(heightInInches - heightInCentimeters / 2.54) > Double.ulpOfOne else { return }
...
var height = Height(heightInCentimeters: 30)
print(height)
height.heightInCentimeters = 40
print(height)

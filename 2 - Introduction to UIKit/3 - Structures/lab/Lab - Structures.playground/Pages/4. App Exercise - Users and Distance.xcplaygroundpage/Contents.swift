 ...
 */
let terry = User(name: "Terry", nickname: "RndmTsk", age: 37, height: 180, weight: 250, activityLevel: 3)
print(terry)
/*:
...
print("1 mile = \(mile.feet) feet")
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
let foot = Distance(feet: 1)
print("1 foot = \(foot.meters) meters")

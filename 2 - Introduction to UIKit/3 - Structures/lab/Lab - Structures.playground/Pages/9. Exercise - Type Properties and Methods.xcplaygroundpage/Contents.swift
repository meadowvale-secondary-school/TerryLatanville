...
struct User {
    ...
    static var currentUser = User(userName: "Terry", email: "terry.latanville@tulip.com", age: 37)
}
...
let newUser = User(userName: "John", email: "johnny.appleseed@apple.com", age: 100)

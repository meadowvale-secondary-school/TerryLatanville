...
progressUpdate(steps: 999, goal: 10000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    guard totalDistance > 0, goalTime > 0 else {
        print("How'd that happen?")
        return
    }
    let percentageDistanceCovered = currentDistance / totalDistance
    let percentageTimeElapsed = currentTime / goalTime
    if percentageDistanceCovered >= percentageTimeElapsed {
        print("Keep it up!")
    } else {
...
pacing(currentDistance: 99, totalDistance: 1000, currentTime: 10, goalTime: 100)
pacing(currentDistance: 0, totalDistance: 0, currentTime: 0, goalTime: 0)
pacing(currentDistance: 1000, totalDistance: 1000, currentTime: 100, goalTime: 100)

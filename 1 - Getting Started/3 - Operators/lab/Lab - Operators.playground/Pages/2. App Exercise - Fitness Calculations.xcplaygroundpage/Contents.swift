...
let heartRate2D = 100.0
let heartRate3D = 75.0
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print("average HR: \(averageHRD)")
print("These are different because of integer division (no decimal places) vs. double division (decimal places)")
/*:
...
print("You made it \(percentOfGoal)% of the way to your goal!")

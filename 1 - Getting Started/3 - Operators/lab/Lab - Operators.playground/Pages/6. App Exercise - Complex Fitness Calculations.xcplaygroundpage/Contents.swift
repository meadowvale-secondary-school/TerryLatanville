...
let heartRate1 = 60.0
let heartRate2 = 75.0
let heartRate3 = 100.0
let averageHeartRate = (heartRate1 + heartRate2 + heartRate3) / 3
print("Your average heart rate is \(averageHeartRate)")
/*:
 ...
 */
let tempInFarenheight = 98.6
let tempInCelsius = (tempInFarenheight - 32) * 5/9
print("\(tempInFarenheight)F = \(tempInCelsius)C")

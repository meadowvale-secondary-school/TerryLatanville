...
print("The shed will be \(area)m^2")
/*:
 ...
 */
let roomArea = area / 2
print("Each room will be \(roomArea)m^2")
/*:
...
print("The perimeter of the shed will be \(perimeter)m")
/*:
 ...
 */
let integerDivisionResult = 10/3 // Expected 3, not 3.3333
print("10/3 = \(integerDivisionResult) when divided as integers")
/*:
...
print("10/3 = \(divisionResult) when divided as doubles")
/*:
